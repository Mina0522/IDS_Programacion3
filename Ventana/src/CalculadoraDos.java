...
public class CalculadoraDos {
	...
	public static void main(String[] args) {
		...
		btn08.setBackground(Color.decode(rosa));
		...
		btn012.setBackground(Color.decode(rosa));
		...
		btn016.setBackground(Color.decode(rosa));
		
		JButton btn017 = new JButton(".");
		btn017.setOpaque(true);
		btn017.setBackground(Color.decode(rosa));
		
		JButton btn018 = new JButton("0");
		btn018.setOpaque(true);
		btn018.setBackground(Color.decode(rosa));
		
		JButton btn019 = new JButton("=");
		btn019.setOpaque(true);
		btn019.setBackground(Color.decode(rosa));
		
		JButton btn020 = new JButton("+");
		btn020.setOpaque(true);
		btn020.setBackground(Color.decode(rosa));
